...
# Path
train_videos_folder_path = "/mnt/RESOURCES/tfg-memorability-challenge/train"
test_videos_folder_path = "/mnt/RESOURCES/tfg-memorability-challenge/test"

# Path model and weights
save_folder_path = '../../models/aesthetics/'
model_save_path = '../../models/aesthetics/aesthetics_autoencoder_model.json'
weight_save_path = '../../models/aesthetics/aesthetics_autoencoder_weight.h5'

# Path for image
img_file_path = '../../figures/aesthetics-autoencoder_train_loss.png'
