...
# Path
train_videos_folder_path = "/mnt/pgth06a/One_Perfect_Shot/shots"
test_videos_folder_path = "/mnt/pgth06a/one-shot/test"

# Path model and weights
save_folder_path = '../../models/one-shot/'
model_save_path = '../../models/one-shot/one-shot_autoencoder_model.json'
weight_save_path = '../../models/one-shot/one-shot_autoencoder_weight.h5'

# Path for image
img_file_path = '../../figures/one-shot-autoencoder_train_loss.png'
...
d = BatchNormalization()(d)
d = Conv2DTranspose(filters=32, kernel_size=(5, 5), strides=2, activation='relu', padding='same')(d)
decoded = Conv2D(filters=3, kernel_size=(5, 5), activation='sigmoid', padding='same')(d)
